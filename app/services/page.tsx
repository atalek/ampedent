        ...
        <div className='grid md:grid-cols-2 grid-cols-1 md:gap-8 gap-6 max-w-[1400px] w-full mx-auto md:justify-stretch my-32'>
          <div className='bg-sky-50 p-8 border border-solid border-black rounded'>
            ...
            <p className='mt-4'>
              ...
              boost your self-esteem, and improve your overall health and
              ability to enjoy eating again. We also offer take-home teeth
              whitening to brighten your smile and help you feel more confident.
            </p>
            <ul className='px-2'>
              <p className='my-2'>
              ...
              <li>
                Custom Take-Home Teeth Whitening Kits & In-Office Whitening
              </li>
            </ul>
          </div>
          <div className='bg-sky-50 p-8 border border-solid border-black rounded'>
            ...
            <p className='mt-4'>
              ...
              become larger concerns. Teeth cleaning can also prevent gum
              disease, cavities, and tooth decay.
            </p>
            <ul className='px-2'>
              <p className='my-2'>Our general dentistry services include:</p>
          ...
          <div className='bg-sky-50 p-8 md:col-span-2 border border-solid border-black rounded'>
            ...
            <p className='mt-8'>
              ...
              prosthetics that replace all of your upper teeth and/or lower
              teeth. These are more secure than traditional dentures and the
              dental implants act as artificial tooth roots, stimulating your
              jaw and helping to prevent bone loss.
            </p>
          </div>
        </div>
      </section>
